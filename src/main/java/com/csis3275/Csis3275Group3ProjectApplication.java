...
public class Csis3275Group3ProjectApplication {
	...
	CommandLineRunner demo(UserServiceImpl_group3 repository, BankingServiceImpl Bankingrepository,
		...
		return (args) -> {
			...
			BankingTrans_group3 bankingTrans1 = new BankingTrans_group3("Deposit", 100.0f, "Deposit for savings", 0.0f, 100.0f, checkingAccount);
			bankingTranService.createBankingTransaction(bankingTrans1);
			
			BankingTrans_group3 bankingTrans2 = new BankingTrans_group3("Withdrawal", 50.0f, "ATM withdrawal", 50.0f, 0.0f, checkingAccount);
